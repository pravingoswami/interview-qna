...
class Answer extends React.Component{
    ...
    componentDidMount = () => {
        axios.get('http://code.dctacademy.com/api/v1/ml/data/questions?key=874561e61c491bcca28217400c517f55')
            .then(response => {
                let questions = response.data
                questions = questions.filter(data => data.answer.includes("javascript"))
